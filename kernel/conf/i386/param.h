...
// blocks" during "big files test" (which writes a single MAXFILE(186)-
// block file). Doubled to 2000, matching forks/amd64-jserv/kernel/
// param.h's own fix for the identical shortfall (its dinode grew the
// same way, earlier).
